...
(function(root, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    define(function(require) {
      ...
      return factory($, require("blobjs"), require("file-saverjs"));
    });
    ...
    module.exports = factory($, require("blobjs"), require("file-saverjs"));
  } else {
    // Browser globals
    root.TableExport = factory(root.jQuery, root.Blob, root.saveAs);
  }
  ...
  TableExport.prototype = {
    ...
    defaults: {
      ...
      filename: "CustomersNumbers", // (id, String), filename for the downloaded file, (default: 'id')
     ...
     * @memberof TableExport.prototype
     */
    defaultFilename: "CustomerNumbers",
    /**
     * Sheetname fallback for exported files.
     * @memberof TableExport.prototype
     */
    defaultSheetname: "CustomerNumbers",
    /**
