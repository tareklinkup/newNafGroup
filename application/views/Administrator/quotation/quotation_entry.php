                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                            <form v-on:submit.prevent="addToCart">
                                <div class="form-group">
                                    <label class="col-xs-3 col-sm-3 col-md-3 col-lg-3 control-label no-padding-right">
                                        Product </label>
                                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                        <v-select id="productm" ref="productm" v-bind:options="products"
                                            v-model="selectedProduct" label="display_text" v-on:input="productOnChange">
                                        </v-select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" step="0.01" placeholder="Qty" class="form-control"
                                ...
                                <div class="form-group" style="display:none;">
                                    ...
                                    <div class="col-sm-9">
                                        <span>(%)</span>
                                        <input type="text" step="0.01" placeholder="Discount" class="form-control"
                                ...
                                <table style="color:#000;margin-bottom: 0px;border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label
                                                    class="col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label no-padding-right">
                                                    Vat </label>
                                                ...
                                                <label
                                                    class="col-xs-1 col-sm-1 col-md-1 col-lg-1 control-label no-padding-right">%</label>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label
                                                    class="col-xs-12 col-sm-12 col-md-12 col-lg-12 control-label no-padding-right">Discount
                                                    Persent</label>
