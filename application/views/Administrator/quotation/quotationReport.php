...
<body>
    <div class="table-responsive" style="">
        <a style="cursor:pointer" onclick="printContent('printPage')"> <i class="fa fa-print"
                style="font-size:20px;color:green"></i> Print</a>

        <div id="printPage" style="width: 70%;">
            <table cellspacing="0" cellpadding="0" style="width: 100%;" id="ttable">
                <tr>
                    <td colspan="2" style="background:#ddd; border-bottom: 1px solid #ccc; margin-bottom: 15px;"
                        align="center"><strong style="font-size:16px;">Quotation Invoice</strong></td>
                </tr>
                <tr>
                    <td>
                        <table width="100%">
      ...
      foreach($rows as $rows){ $i++;
            ...
            ?>
                ...
                <tr>
                    ...
                    <td style="border:0px">
                        <?php $totalamount =$totalamount+$Ptotalamount; echo number_format($totalamount,2); ?></td>
                </tr>
                ...
                <tr>
                    ...
                    <td style="border:0px">
                        <?php $discount = $selse->SaleMaster_TotalDiscountAmount;echo number_format($discount,2) ?></td>
                </tr>
                <tr>
                    <td style="border-left: 0px ;border-right: 0px ;border-bottom: 0px; border-top: 0px solid;"></td>
                    <td
                        style="color:red;border:0px; border-top: 0px solid #999;border-left: 0px ;border-right: 0px ;border-bottom: 0px;">
                    </td>
                    <td colspan="3" style="border:0px"></td>
                ...
                <tr>
                    <td colspan="5" style="border:0px"></td>
                    <td colspan="2"
                        style="border-top: 2px solid #999;border-left: 0px ;border-right: 0px ;border-bottom: 0px ;">
                    </td>
                ...
                <tr>
                    ...
                    <td style="border:0px">
                        <strong><?php $grandtotal = $totalamount-$discount+$vat-$RewordDiscount; echo number_format($grandtotal,2)?></strong>
                    </td>
                </tr>
            </table>
            <p>Total (in word): <?php
