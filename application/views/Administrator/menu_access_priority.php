        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="hrPayroll">
                    ...
                    <li><input type="checkbox" class="access" value="leave_pending" v-model="access"> Leave Pending
                    </li>
                    <li><input type="checkbox" class="access" value="leave_entry_report" v-model="access"> Leave Record
                    </li>
                </ul>
            </div>
        </div>
