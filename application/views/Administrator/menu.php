...
<ul class="nav nav-list">
    ...
    <?php if (
			array_search("leave_entry", $access) > -1
			|| array_search("leave_pending", $access) > -1
            || array_search("leave_entry_report", $access) > -1
			|| isset($CheckSuperAdmin) || isset($CheckAdmin)
		) : ?>
    <li class="">
        <a href="<?php echo base_url(); ?>" class="dropdown-toggle">
        ...
        <ul class="submenu">
            ...
            <?php if (array_search("leave_pending", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <li class="">
                <a href="<?php echo base_url(); ?>leave_pending">
                    <i class="menu-icon fa fa-money"></i>
                    <span class="menu-text"> Leave Pending </span>
                </a>
                <b class="arrow"></b>
            </li>
            <?php endif; ?>
