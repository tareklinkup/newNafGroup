                ...
                <table id="table" class="record-table">
                    ...
                    <tbody>
                        <tr style="text-align: center;">
                            ...
                            <td>{{ selectedIEMI.SaleDetails_Rate}}</td>
                            <td>
                                <input type="text" style="text-align: center;"
                                    v-model="selectedIEMI.sale_return_amount">
                            </td>
                            <td>
...
new Vue({
    ...
    methods: {
        getPurchaseIMEI() {
            axios.get('/get_sales_serials').then(res => {
        ...
        doReturnProduct() {
            ...
            axios.post("/sale_imei_return", this.selectedIEMI).then(res => {
