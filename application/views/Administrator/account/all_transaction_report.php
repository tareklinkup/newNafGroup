...
<div id="cashTransactionReport">
    ...
    <div style="margin-top: 5px;" class="row" style="display:none;" v-bind:style="{display: transactions.length > 0 ? '' : 'none'}">
        <div class="col-md-6" style="margin-top:15px;margin-bottom:15px;">
            <a href="" @click.prevent="print"><i class="fa fa-print"></i> Print</a>
        </div>
        <div class="col-md-6 text-right">
            <button class="btn btn-sm btn-success" onclick="exportTableToCSV('transaction-list.csv')">Export To CSV</button>
        </div>
        <div class="col-md-12">
