                    ...
                    <tbody>
                        ...
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                {{ transactions.reduce((p, c) => { return +p + +c.receive }, 0) }}</td>
                            <td style="text-align:right;">
                                {{ transactions.reduce((p, c) => { return +p + +c.profit }, 0) }}</td>
                            <td style="text-align:right;">
                                {{ transactions.reduce((p, c) => { return +p + +c.payment }, 0) }}</td>
...
new Vue({
    ...
    methods: {
        ...
        async print() {
            ...
            if (this.selectedAccount != null) {
                accountText =
                    `<strong>Account: </strong> ${this.selectedAccount.Acc_Code} - ${this.selectedAccount.Acc_Name}<br>`;
            }
