                ...
                <table class="table table-bordered table-condensed" id="transactionsTable">
                    ...
                    <tbody>
                        <tr v-for="(transaction, sl) in transactions">
                            ...
                            <td style="text-align:right">
                                {{ transaction.transaction_type == 'deposit' ? transaction.deposit : '' }}</td>
                            <td style="text-align:right">
                                {{ transaction.transaction_type == 'withdraw' ? transaction.withdraw : '' }}</td>
                        </tr>
                    </tbody>
                    ...
                    <tfoot>
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">
                                {{ totalDeposit = this.transactions.filter(t => t.transaction_type == 'deposit').reduce((prev, curr) => { return prev + parseFloat(curr.deposit)}, 0) }}
                            </td>
                            <td style="text-align:right;">
                                {{ totalWithdraw = this.transactions.filter(t => t.transaction_type == 'withdraw').reduce((prev, curr) => { return prev + parseFloat(curr.withdraw)}, 0) }}
                            </td>
                        </tr>
                    </tfoot>
                </table>
