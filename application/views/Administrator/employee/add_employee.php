        ...
        <div class="form-horizontal">
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="Employeer_id" id="Employeer_id" name="Employeer_id"
                            value="<?php echo $generateCode; ?>" class="form-control" readonly />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" id="bio_number" name="bio_number"
                            value="<?php echo set_value('bio_number'); ?>" placeholder="Bio Number .."
                            class="form-control" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <input type="text" id="em_name" name="em_name" value="<?php echo set_value('em_name'); ?>"
                ...
                <div class="form-group">
					...
					$row = $query->result();
					foreach($row as $row){ ?>
                            <option value="<?php echo $row->Designation_SlNo; ?>"><?php echo $row->Designation_Name; ?>
                            </option>
                            <?php } ?>
                        </select>
                    ...
                    <div class="col-sm-1" style="padding: 0;">
                        <a href="<?= base_url('designation')?>" title="Add New Designation"
                            class="btn btn-xs btn-danger"
                            style="height: 25px; border: 0; width: 27px; margin-left: -10px;" target="_blank"><i
                                class="fa fa-plus" aria-hidden="true" style="margin-top: 5px;"></i></a>
                    </div>
                </div>
                ...
                <div class="form-group">
					...
					foreach($drow as $drow){ ?>
                            <option value="<?php echo $drow->Department_SlNo; ?>"><?php echo $drow->Department_Name; ?>
                            </option>
                            <?php } ?>
                        </select>
                    ...
                    <div class="col-sm-1" style="padding: 0;">
                        <a href="<?= base_url('depertment')?>" title="Add New Department" class="btn btn-xs btn-danger"
                            style="height: 25px; border: 0; width: 27px; margin-left: -10px;" target="_blank"><i
                                class="fa fa-plus" aria-hidden="true" style="margin-top: 5px;"></i></a>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" id="salary_range" name="salary_range"
                            value="<?php echo set_value('phone_number'); ?>" placeholder="Salary Range .."
                            class="form-control" />
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <input type="text" id="em_contact" name="em_contact" placeholder="Contact No"
                            class="form-control" />
                    </div>
                </div>
        ...
        <div class="form-horizontal">
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <input type="text" id="em_father" name="em_father" placeholder="Father's Name"
                            class="form-control" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <input class="form-control date-picker" name="em_dob" id="em_dob" type="text"
                            data-date-format="yyyy-mm-dd" style="border-radius: 5px !important;"
                            value="<?php echo date("Y-m-d") ?>" />
                    </div>
                </div>
...
function Employee_submit() {
    ...
    var em_bio_number = $("#bio_number").val();
    ...
    fd.append('bio_number', $('#bio_number').val());
    ...
    fd.append('ref_name', $('#ref_name').val());
    fd.append('ref_contact', $('#ref_contact').val());
