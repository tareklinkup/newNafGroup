            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        ...
                        <v-select v-bind:options="employees" label="display_name" v-model="selectedEmployee"
                            @input="getPayableSalary" style="display:none;"
                            v-bind:style="{display: employees.length > 0 ? '' : 'none'}"></v-select>
                    </div>
                    <div class="col-md-1" style="padding:0;margin-left: -15px;"><a href="/employee" target="_blank"
                            class="add-button"><i class="fa fa-plus"></i></a></div>
                </div>
                <div class="form-group" v-if="selectedEmployee != null" style="display:none;"
                    v-bind:style="{display: selectedEmployee == null ? 'none' : ''}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        ...
                        <v-select v-bind:options="months" label="month_name" v-model="selectedMonth"
                            @input="getPayableSalary" style="display:none;"
                            v-bind:style="{display: months.length > 0 ? '' : 'none'}"></v-select>
                    </div>
                    <div class="col-md-1" style="padding:0;margin-left: -15px;"><a href="/month" target="_blank"
                            class="add-button"><i class="fa fa-plus"></i></a></div>
                </div>

                <div class="form-group" style="display:none;"
                    v-bind:style="{display: payment.employee_payment_id == null ? '' : 'none'}">
