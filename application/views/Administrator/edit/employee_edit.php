        ...
        <div class="form-horizontal">
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="Employeer_id" id="Employeer_id" name="Employeer_id"
                            value="<?php echo $selected->Employee_ID; ?>" class="form-control" readonly />
                        <input name="Employeer_id" type="hidden" id="Employeer_id" class="required"
                            value="<?php echo $selected->Employee_ID; ?>" />
                        <input name="iidd" type="hidden" id="iidd" class="required"
                            value="<?php echo $selected->Employee_SlNo; ?>" />
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-sm-4 control-label" for="em_name"> Bio Number</label>
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <input type="text" id="bio_number" name="bio_number"
                            value="<?php echo $selected->bio_number; ?>" placeholder="Bio Number .."
                            class="form-control" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <input type="text" id="em_name" name="em_name" value="<?php echo $selected->Employee_Name; ?>"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select class="chosen-select form-control" name="em_Designation" id="em_Designation"
                            data-placeholder="Choose a Designation...">
                            <option value=""> </option>
                            <?php 
					$query = $this->db->query("SELECT * FROM tbl_designation where Status='a' order by Designation_Name asc");
					$row = $query->result();
					foreach($row as $row){ ?>
                            <option value="<?php echo $row->Designation_SlNo; ?>"
                                <?php if($selected->Designation_ID == $row->Designation_SlNo){?> selected="selected"
                                <?php } ?>><?php echo $row->Designation_Name; ?></option>
                            <?php } ?>
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select class="chosen-select form-control" name="em_Depertment" id="em_Depertment"
                            data-placeholder="Choose a Depertment...">
                            <option value=""> </option>
                            <?php 
					$dquery = $this->db->query("SELECT * FROM tbl_department order by Department_Name asc ");
					$drow = $dquery->result();
					foreach($drow as $drow){ ?>
                            <option value="<?php echo $drow->Department_SlNo; ?>"
                                <?php if($selected->Department_ID == $drow->Department_SlNo){?> selected="selected"
                                <?php } ?>><?php echo $drow->Department_Name; ?></option>
                            <?php } ?>
                        </select>
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <input class="form-control date-picker" name="em_Joint_date" id="em_Joint_date" type="text"
                            data-date-format="yyyy-mm-dd" style="border-radius: 5px !important;"
                            value="<?php echo $selected->Employee_JoinDate; ?>" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" id="salary_range" name="salary_range"
                            value="<?php echo $selected->salary_range; ?>" placeholder="Salary Range .."
                            class="form-control" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select class="chosen-select form-control" name="status" id="status"
                            ...
                            <option value=""> </option>
                            <option value="a" <?php if($selected->status=='a'){?> selected="selected" <?php } ?>> Active
                            </option>
                            <option value="d" <?php if($selected->status=='d'){?> selected="selected" <?php } ?>>
                                Deactive </option>
                        </select>
                    </div>
                </div>
            ...
            <div class="col-sm-6">
                <div class="col-sm-12 align-center"> <strong>Reference Information</strong></div>

                <hr />
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="em_Present_address"> Ref Name </label>
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <input type="text" id="ref_name" name="ref_name" placeholder="Reference Name"
                            class="form-control" value="<?php echo $selected->ref_name; ?>" />
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-sm-4 control-label" for="em_contact">Ref Contact No </label>
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <input type="text" id="ref_contact" name="ref_contact" placeholder="Ref Contact No"
                            class="form-control" value="<?php echo $selected->ref_contact; ?>" />
                    </div>
                </div>
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <input type="text" id="em_Present_address" name="em_Present_address"
                            value="<?php echo $selected->Employee_PrasentAddress; ?>" placeholder="Present Address"
                            class="form-control" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <input type="text" id="em_Permanent_address" name="em_Permanent_address"
                            value="<?php echo $selected->Employee_PermanentAddress; ?>" placeholder="Present Address"
                            class="form-control" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" id="em_contact" name="em_contact"
                            value="<?php echo $selected->Employee_ContactNo; ?>" placeholder="Purchase Rate"
                            class="form-control" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <input type="text" id="ec_email" name="ec_email"
                            value="<?php echo $selected->Employee_Email; ?>" placeholder="E-mail"
                            class="form-control" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <input type="file" id="em_photo" name="em_photo" class="form-control" onchange="readURL(this)"
                            style="height:35px" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label"></label>
                    <div class="col-sm-6">
                        <button type="button" onclick="Employee_submit()" name="btnSubmit" title="Save"
        ...
        <div class="form-horizontal">
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <input type="text" id="em_father" name="em_father"
                            value="<?php echo $selected->Employee_FatherName; ?>" placeholder="Father's Name"
                            class="form-control" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" id="mother_name" name="mother_name"
                            value="<?php echo $selected->Employee_MotherName; ?>" placeholder="Mother's Name"
                            class="form-control" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select class="chosen-select form-control" name="Gender" id="Gender"
                            data-placeholder="Choose a Gender...">
                            <option value=""> </option>
                            <option value="Male" <?php if($selected->Employee_Gender == 'Male'){?> selected="selected"
                                <?php } ?>>Male</option>
                            <option value="Female" <?php if($selected->Employee_Gender == 'Female'){?>
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <input class="form-control date-picker" name="em_dob" id="em_dob"
                            value="<?php echo $selected->Employee_BirthDate; ?>" type="text"
                            data-date-format="yyyy-mm-dd" style="border-radius: 5px !important;" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select class="chosen-select form-control" name="Marital" id="Marital"
                            data-placeholder="Choose a Marital Status...">
                            <option value=""> </option>
                            <option value="married" <?php if($selected->Employee_MaritalStatus == 'married'){?>
                                selected="selected" <?php } ?>>Married</option>
                            <option value="unmarried" <?php if($selected->Employee_MaritalStatus == 'unmarried'){?>
                                selected="selected" <?php } ?>>Unmarried</option>
                        </select>
                    </div>
                </div>
            ...
            <div class="col-sm-6">
                ...
                <img id="preview"
                    src="<?php echo base_url(); ?>uploads/employeePhoto_thum/<?php echo $selected->Employee_Pic_thum; ?>"
