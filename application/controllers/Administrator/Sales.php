...
class Sales extends CI_Controller
{
    ...
    public function iemiHistory()
    {
        ...
        $data['title'] = "IEMI History";
        $data['content'] = $this->load->view('Administrator/sales/imei_history', $data, TRUE);
        $this->load->view('Administrator/index', $data);
    }
    ...
    function GetIMEIList()
    {
        ...
        $imei = $this->db->query("SELECT ps.*,ps.ps_s_discount as SaleDetails_Discount,ps.ps_prod_id,p.*,u.Unit_Name,pc.ProductCategory_Name
        FROM  tbl_product_serial_numbers as ps
        INNER JOIN tbl_product as p 
