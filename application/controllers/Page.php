...
class Page extends CI_Controller {
   ...
   public function noteedit($id)
     {
         ...
         $data['content'] = $this->load->view('Administrator/edit/note_edit', $data, TRUE);
         $this->load->view('Administrator/index', $data);
     }
 ...
 // Get Size
     ...
     {
         $units = $this->db->query("select n.*, n.description as Display_Size from tbl_leave_note s where status = 'a'")->result();
